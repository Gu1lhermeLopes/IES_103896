...
public class ApiController {
  ...
  public Meeting oneMeeting(@PathVariable Long id) {
      return service.findById(id);
  }

  @GetMapping("/meetings/{id}/c")
  public Set<Contact> oneMeetingContact(@PathVariable Long id) {
      return service.getMeetingContacts(id);
  }
  ...
  public Meeting cloneMeeting(@PathVariable Long id) {
    ...
    public Map<String, Boolean> deleteContact(@PathVariable Long id) {
  ...
  public Contact addMeetContact(@PathVariable Long id, @PathVariable Long contactId) {
    ...
    //ADD CONTACT TO MEET
    @PutMapping("/meetings/{id}/{contactId}/r")
    public Contact removeMeetContact(@PathVariable Long id, @PathVariable Long contactId) {
        return service.removeContact(id, contactId);
    }
