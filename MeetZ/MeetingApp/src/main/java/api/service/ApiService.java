...
public class ApiService {
    ...
    public Set<Contact> getMeetingContacts(Long id){
    ...
    //ADD CONTACTS
    public Contact removeContact(Long id,Long contactId){
        Set<Meeting> mset=null;
        Meeting m = findById(id);
        Contact c=findContactById(contactId);
    ...
    public Map<String, Boolean> deleteContact(Long id) {
        Contact m=findContactById(id);
        contactRepository.delete(m);
        Map<String, Boolean> response = new HashMap<>();
        response.put("deleted", Boolean.TRUE);
        return response;
